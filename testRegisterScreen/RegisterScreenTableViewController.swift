...
//  testRegisterScreen
//
//  Created by Wyant, Benjamin on 6/20/18.
//  Copyright © 2018 Wyant, Benjamin. All rights reserved.
//

import UIKit

class RegisterScreenTableViewController: UITableViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    @IBOutlet weak var confirmEmailStackView: UIStackView!
    @IBOutlet weak var confirmEmailTextField: UITextField!
    @IBOutlet weak var confirmEmailErrorLabel: UILabel!
    
    
    @IBOutlet weak var favoriteColorStackView: UIStackView!
    ...
    @IBAction func usernameTextFieldChanged(_ sender: Any) {
        usernameErrorLabel.text = usernameTextField.text
    }
    ...
    @IBAction func confirmEmailTextFieldChanged(_ sender: Any) {
    }
    ...
    override func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        ...
        if indexPath.section < 5 {
            ...
            return favoriteColorStackView.bounds.height
        } else {
            return 60
        }
    }
